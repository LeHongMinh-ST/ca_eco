...
/**
 * InventoryDecreased domain event is raised when inventory quantity is decreased
 */
export class InventoryDecreased implements DomainEvent {
  readonly name = "InventoryDecreased";
